...
<div class="bg-secondary rounded-0 text-white research-heading">
   <div class="container p-3">
      <div class="row justify-content-center">
         <div class="col-sm-8">
            <h3 class="fw-bold">ATOMIC, MOLECULAR AND OPTICAL PHYSICS</h3>
         </div>
      </div>
   </div>
</div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <img src="images/research/AMO1.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                     <img src="images/research/AMO2.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                     <img src="images/research/AMO3.jpg" class="d-block w-100" alt="...">
                  </div>
                  <!-- <div class="carousel-item">
   ...
   <div class="rounded-0">
      <div class="container ">
         <div class="row ">
            ...
            <ol class="lead">
            <?php
            $sqlFetchresearch = "SELECT * from research where page='amo'";
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <a href='research_amo_members.php'>Link to Members Page</a>
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item">
                           ...
                           <div class="card-body bg-header text-dark">
                              <p class="card-text">
                                 <marquee direction="up" behavior="scroll" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="3">
                                    <ul class="list-group">
                                    <?php
                                    $sqlFetchAnnouncements = "SELECT announcementTitle, announcementLink FROM research_announcements where page='amo'";
