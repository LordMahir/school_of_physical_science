...
<div class="bg-secondary rounded-0 text-white">
   <div class="container p-3">
      <div class="row justify-content-center">
         <div class="col-sm-12">
            <h3 class="fw-bold faculty-heading">HIGH ENERGY PHYSICS</h3>
         </div>
      </div>
   </div>
</div>
   ...
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      ...
      <h3 style="text-align:center;">FACULTY</h3>
         <?php
            ...
            personalWebsite,researchText FROM faculty where (id=13)";
         ...
         <?php
            $sqlFetchStudents = "SELECT id,name,email,image FROM students where page='hep'";
