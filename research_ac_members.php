   ...
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      <div class="row justify-content-center">
         <?php
            ...
            personalWebsite,researchAreas FROM faculty where (id=1 or id=10 or id=5 or id=8)";
                  ...
                  <div class="row no-gutters">
                     ...
                     <div class="col"><a href="faculty_personal.php?id='.$row['id'].'" button" target="_blank">
                        <div class="card-block px-2">
                           ...
                           <p class="mb-2" style="overflow:hidden;max-height:100px;"><b>Research Areas :</b> '.$row['researchAreas'].'</p>
                           <a href="#" class="btn btn-outline-primary mb-2 button" target="_blank">Personal Webpage</a>
         ...
         ?></div>
      		...
      		<div class="row justify-content-center">
         <?php
            $sqlFetchStudents = "SELECT id,name,email,phone,image FROM students where page='amo'";
