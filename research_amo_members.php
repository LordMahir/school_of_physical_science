...
<div class="bg-secondary rounded-0 text-white">
   <div class="container p-3">
      <div class="row justify-content-center">
         <div class="col-sm-12">
            <h3 class="fw-bold faculty-heading">ATOMIC, MOLECULAR AND OPTICAL PHYSICS</h3>
         </div>
      </div>
   </div>
</div>
   ...
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      <div class="row justify-content-center">
         ...
         $sqlFetchFaculty = "SELECT id,name,designation,email,phone,image,
            personalWebsite,researchText FROM faculty where (id=1 or id=10 or id=5 or id=8)";
...
<section class="bg-grey p-3">
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      ...
      <div class="row justify-content-center">
         <?php
         $sqlFetchStudents = "SELECT id,name,email,image FROM students where page='amo'";
