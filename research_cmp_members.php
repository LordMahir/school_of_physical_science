...
<div class="bg-secondary rounded-0 text-white">
   <div class="container p-3">
      <div class="row justify-content-center">
         <div class="col-sm-12">
            <h3 class="fw-bold faculty-heading">CONDENSED MATTER PHYSICS</h3>
         </div>
      </div>
   </div>
</div>
   ...
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      ...
      <h3 style="text-align:center;">FACULTY</h3>
         ...
         $sqlFetchFaculty = "SELECT id,name,designation,email,phone,image,
            personalWebsite,researchText FROM faculty where (id=1 or id=2 or id=14 or id=3 or id=4 or id=11 or id=6 or id=7 or id=10 )";
...
<section class="bg-grey p-3">
   <div class="faculty-profiles container p-2" id="faculty-profiles">
      <div class="row justify-content-center">
         ...
         <?php
         $sqlFetchStudents = "SELECT id,name,email,image FROM students where page='cmp'";
