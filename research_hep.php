...
<div class="bg-secondary rounded-0 text-white research-heading">
   <div class="container p-3">
      <div class="row justify-content-center">
         <div class="col-sm-8">
            <h3 class="fw-bold">HIGH ENERGY PHYSICS</h3>
         </div>
      </div>
   </div>
</div>
   ...
   <div class="rounded-0">
      <div class="container ">
         <div class="row ">
            ...
            <ol class="lead">
            <?php
            $sqlFetchresearch = "SELECT * from research where page='hep'";
                  ...
                  <div class="accordion-item">
                     ...
                     <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                           <a href='research_hep_members.php'>Link to Members Page</a>
                        </div>
                     </div>
                  </div>
                  <div class="accordion-item">
                           ...
                           <div class="card-body bg-header text-dark">
                              <p class="card-text">
                                 <marquee direction="up" behavior="scroll" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="3">
                                    <ul class="list-group">
                                    <?php
                                    $sqlFetchAnnouncements = "SELECT announcementTitle, announcementLink FROM research_announcements where page='hep'";
